...
const MobileDrawer = ({
  ...
  const closeDrawerMinWidth = {
    minWidth: `${windowWidth * 0.75 > 300 && windowWidth - 320}px`,
  };
  const colorSpan = {
      ...
      <div>
        ...
        <div className={classNames.containerDrawer}>
          <div
            ...
            className={`${classNames.closeDrawer} ${
              isOpen ? classNames.open : ""
            }`}
          ></div>
          <div
            className={`${classNames.drawer} ${isOpen ? classNames.open : ""}`}
          >
            ...
            <div className={classNames.containerMenu}>
              {menu.map(({ name, isOnlyDesktop, onClick }) =>
                !isOnlyDesktop && (
